  ...
  return (
    <>
      ...
      <div style={{ background: "#fff", borderBottom: "1px solid #D5D5D5" }}>
        <div style={{ maxWidth: 960, margin: "0 auto", padding: "clamp(24px, 6vw, 40px) 24px clamp(20px, 5vw, 32px)" }}>
          <p style={{ fontSize: 12, letterSpacing: 1.5, textTransform: "uppercase", color: "#2B6CB0", fontWeight: 600, marginBottom: 16 }}>
            Life Framework
          </p>
          <h1 className="sf" style={{ fontSize: "var(--fs-h1)", fontWeight: 300, lineHeight: 1.35, color: "#1A1A1A", marginBottom: 12, maxWidth: 660 }}>
