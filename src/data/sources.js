...
export const SOURCES = [
  {
    ...
    items: [
      ...
      { author: "Frankl, V.", title: "Man's Search for Meaning", year: 1946, note: "Logotherapy — meaning as the primary human drive. Basis for the Inner Life & Meaning domain and 'creative values' in Work & Craft." },
      ...
      { author: "Csikszentmihalyi, M.", title: "Flow: The Psychology of Optimal Experience", year: 1990, note: "Flow states from challenge-skill balance. Basis for Mind & Growth and Creative Expression subcategories." },
      ...
      { author: "Erikson, E.", title: "Identity and the Life Cycle", year: 1959, note: "Eight stages of psychosocial development. Basis for Cultural & Identity Belonging subcategory." },
    ]
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { author: "Ericsson, A. & Pool, R.", title: "Peak: Secrets from the New Science of Expertise", year: 2016, note: "Deliberate practice theory. Foundation for Mastery & Skill Development subcategory." },
  ...
  },
  {
    ...
    items: [
      { author: "Granovetter, M.", title: "The Strength of Weak Ties (American Journal of Sociology, 78(6))", year: 1973, note: "Weak ties as bridges to opportunity and information. Foundation for Social Network & Weak Ties subcategory." },
      ...
      { author: "Turkle, S.", title: "Alone Together: Why We Expect More from Technology and Less from Each Other", year: 2011, note: "Digital community's impact on belonging and self-concept. Basis for Digital Community subcategory." },
  ...
  },
  {
    ...
    items: [
      ...
      { author: "Marcus Aurelius", title: "Meditations", year: "c. 170 CE", note: "Stoic practice — what you can and cannot control, memento mori, self-examination. Referenced in Inner Life & Meaning." },
      ...
      { author: "Nietzsche, F.", title: "Twilight of the Idols", year: 1889, note: "'He who has a why can bear almost any how.' Referenced in Purpose & Direction." },
      { author: "Heidegger, M.", title: "Being and Time", year: 1927, note: "Being-toward-death — authentic existence through confronting mortality. Referenced in Relationship with Mortality." },
      ...
      { author: "Huizinga, J.", title: "Homo Ludens: A Study of the Play-Element in Culture", year: 1938, note: "Play as foundational to culture. Basis for Active Recreation & Hobbies." },
    ]
  },
  {
    category: "Existential & Meaning-Making",
    items: [
      { author: "Frankl, V.", title: "The Will to Meaning: Foundations and Applications of Logotherapy", year: 1969, note: "Logotherapy — meaning through creative values, experiential values, and attitudinal values. Underpins Inner Life domain." },
      { author: "Yalom, I.", title: "Staring at the Sun: Overcoming the Terror of Death", year: 2008, note: "Existential therapy — facing mortality reduces anxiety. Referenced in Mortality subcategory." },
      ...
      { author: "James, W.", title: "The Varieties of Religious Experience", year: 1902, note: "Psychological study of mystical and spiritual experience. Background for Spiritual Practice subcategory." },
  ...
  },
  {
    ...
    items: [
      { author: "Buddhist Canon", title: "Dhammapada; Anicca (impermanence); Noble Eightfold Path; Samadhi (concentration)", year: "c. 3rd century BCE", note: "Impermanence, right intention, mindfulness practice. Referenced in Mortality, Purpose, Cognitive Maintenance, and Spiritual Practice." },
      { author: "Lao Tzu", title: "Tao Te Ching", year: "c. 6th century BCE", note: "Wu wei (non-action), naturalness, simplicity. Referenced in Passive Restoration subcategory." },
      { author: "Bhagavad Gita", title: "Hindu scripture", year: "c. 2nd century BCE", note: "Karma yoga (selfless action), dharma (purpose), detachment from outcomes. Referenced in Purpose, Spiritual Practice." },
      { author: "Book of Psalms", title: "Hebrew Bible / Old Testament", year: "c. 10th–5th century BCE", note: "Contemplative prayer, lament, praise. Referenced in Spiritual Practice." },
      ...
      { author: "Islamic tradition", title: "Niyyah (intention); Taqwa (God-consciousness); Jamal (divine beauty); Ummah (community)", year: "", note: "Intention as foundation of action, moral compass, beauty as divine attribute, communal belonging. Referenced across Inner Life, Values, Aesthetics, Community." },
      { author: "Judeo-Christian tradition", title: "Sabbath; Klal Yisrael (communal belonging); Catholic social teaching (subsidiarity)", year: "", note: "Mandatory rest, community as obligation, local governance. Referenced in Play & Rest, Community." },
  ...
  },
  {
    ...
    items: [
      ...
      { author: "Adams, S.", title: "How to Fail at Almost Everything and Still Win Big", year: 2013, note: "Skill stacking — combining top-20% competencies. Referenced in Career Strategy." },
      ...
      { author: "Emmons, R. & McCullough, M.", title: "Counting Blessings Versus Burdens (Journal of Personality and Social Psychology, 84(2))", year: 2003, note: "Gratitude journaling improves well-being. Referenced in Spiritual Practice." },
      ...
      { author: "Housel, M.", title: "The Psychology of Money", year: 2020, note: "Behavioral finance and wealth-building mindset. Referenced in Financial Health." },
      { author: "Bogle, J.", title: "The Little Book of Common Sense Investing", year: 2007, note: "Index investing philosophy. Referenced in Financial Health practices." },
      { author: "Kaplan, S.", title: "The Restorative Benefits of Nature (Journal of Environmental Psychology, 15(3))", year: 1995, note: "Attention restoration theory — nature and plants reduce cognitive fatigue. Referenced in Physical Environment." },
    ]
  },
];
